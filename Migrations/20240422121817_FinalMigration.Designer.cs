...
namespace Splitwise.Migrations
{
    ...
    [Migration("20240422121817_FinalMigration")]
            ...
            modelBuilder.Entity("Splitwise.Entities.Group", b =>
                {
                    ...
                    b.Property<int>("GroupDetailsGroupDetailId")
                        .HasColumnType("int");

                    b.HasKey("GroupId");

                    b.HasIndex("GroupDetailsGroupDetailId");
            ...
            modelBuilder.Entity("Splitwise.Entities.Group", b =>
                {
                    b.HasOne("Splitwise.Entities.GroupDetail", "GroupDetails")
                        .WithMany()
                        .HasForeignKey("GroupDetailsGroupDetailId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
